...
| Persistence | Portable D1 metadata/session/ledger and R2 evidence adapters | Staging D1 is provisioned and migrations `0001`–`0004` are applied; R2 account enablement is reported, while bucket creation, binding, access, and retention policy remain to be verified. |
